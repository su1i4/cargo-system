        ...
        <div style={{ transform: "scale(0.95)" }}>
          ...
          >
            ...
            <Col style={colStyle} span={12}>
              <Text style={{ textAlign: "end", fontWeight: "bold" }}>
                Итого
              </Text>
            </Col>
            <Col style={colStyle} span={2}>
          ...
          {record?.products?.length ? (
            ...
            >
              <Col
                span={10}
                style={{ ...colStyle, backgroundColor: "#F5F5F4" }}
              >
          ...
          <Flex gap={16} style={{ marginTop: 5 }}>
            <Flex vertical style={{ width: "50%", fontSize: 13 }}>
              ...
              <Text style={{ fontSize: 13, fontWeight: 600, marginBottom: 4 }}>
                ...
                Турции - по 1000 руб., в) товары производства Китая и других
                стран - по 750 руб. Гарантия не распространяется на досылы
              </Text>
            ...
            <Flex vertical style={{ width: "50%", fontSize: 13 }}>
              <Text style={{ fontSize: 11, marginBottom: 4 }}>
                4. Стоимость доставки указана только до конечных городов:
                Москва, Новосибирск, Екатеринбург. За досыл в другие города
                взимается дополнительная плата в соответствии с тарифами местных
              ...
              <Text style={{ fontSize: 11 }}>
                ...
                обработку. 6. Подписанием данного документа Клиент /
                представитель Клиента подтверждает, что ознакомлен и согласен со
                всеми его условиями. Накладная составлена в двух экземплярах, по
                одной для каждой из сторон, и имеет равную юридическую силу
              </Text>
            </Flex>
          </Flex>
          <Flex
